...
```
# run the versioned corpus (36 cases) and write records for an experiment
...
case (corpus version `agent-corpus-1.0`: 6 incident kinds + 6 edge cases x
{heuristic, llm-scripted} + 10 adversarial LLM cases), runs both reasoners
